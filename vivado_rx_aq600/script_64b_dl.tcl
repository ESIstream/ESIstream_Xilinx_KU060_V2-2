...
set project_name vivado_rx_aq600_64b_dl
set path_file [ dict get [ info frame 0 ] file ]
set path_src [string trimright $path_file "/script_64b_dl.tcl"]
...
# Add xdc source file
add_files -fileset constrs_1 $path_xdc/rx_esistream_top_64b_dl.xdc
