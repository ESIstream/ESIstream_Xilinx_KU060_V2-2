...
set project_name vivado_rx_aq600_32b
set path_file [ dict get [ info frame 0 ] file ]
set path_src [string trimright $path_file "/script_32b.tcl"]
...
add_files $path_src_rx_ip/rx_xcvr_wrapper_32b.vhd
...
# Add xdc source file
add_files -fileset constrs_1 $path_xdc/rx_esistream_top_32b.xdc
